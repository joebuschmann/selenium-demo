...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "GoogleSearch", "\tIn order to find information on the internet\r\n\tas a user of the Google search en" +
        ...
        [NUnit.Framework.DescriptionAttribute("Perform a Basic Search")]
        public virtual void PerformABasicSearch()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Perform a Basic Search", ((string[])(null)));
#line 7
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("length", "5", "kilometer", "3.10686", "mile", null)]
        [NUnit.Framework.TestCaseAttribute("mass", "5", "kilogram", "11.0231", "pound", null)]
        [NUnit.Framework.TestCaseAttribute("digital storage", "1000", "kilobyte", "1", "megabyte", null)]
